    ...
    public partial class ReportIssues : Form
    {
        ...
        private void SubmitIssue(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ID = SharedDataModel.serviceIssues.Count + 1;

                string chosen = cmbxCategory.SelectedItem?.ToString();
                ...
                SharedDataModel.serviceIssues.Add(issue);
