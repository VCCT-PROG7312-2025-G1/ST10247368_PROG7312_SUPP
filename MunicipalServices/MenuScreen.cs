...
namespace MunicipalServices
{
    ...
    {
        public static CheckStatus SharedCheckStatus = new CheckStatus();
        ...
        public MenuScreen()
        {
            ...
            btnReportIssues.Font = new Font("Calibri", 14);
            btnReportIssues.BackColor = Color.Blue;
            btnReportIssues.Size = new Size(180, 60);
            ...
            btnLocalEvents.Size = new Size(180, 60);
            btnLocalEvents.Font = new Font("Calibri", 14);
            btnLocalEvents.BackColor = Color.Yellow;
            ...
            btnCheckStatus.Size = new Size(180, 60);
            btnCheckStatus.Font = new Font("Calibri", 14);
            btnCheckStatus.BackColor = Color.Green;
